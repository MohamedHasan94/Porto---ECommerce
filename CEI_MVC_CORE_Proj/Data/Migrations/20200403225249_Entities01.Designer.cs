...
namespace CEI_MVC_CORE_Proj.Data.Migrations
{
    ...
    [Migration("20200403225249_Entities01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CEI_MVC_CORE_Proj.Models.Sale", b =>
                {
                    b.Property<int>("FK_ProductId");
            ...
            modelBuilder.Entity("CEI_MVC_CORE_Proj.Models.PaymentMethod", b =>
                {
                    b.HasOne("CEI_MVC_CORE_Proj.Models.Product", "Propduct")
            ...
            modelBuilder.Entity("CEI_MVC_CORE_Proj.Models.Sale", b =>
                {
                    b.HasOne("CEI_MVC_CORE_Proj.Models.Product", "Propduct")
                        .WithOne("Sale")
                        .HasForeignKey("CEI_MVC_CORE_Proj.Models.Sale", "FK_ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
